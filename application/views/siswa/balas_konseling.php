            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="mt-2 font-weight-bold text-primary">Pengajuan : <?= mediumdate_indo(date($konseling['tgl_pengajuan'])); ?>
                        <a href="<?= base_url('siswa/konseling') ?>" class="p-2 badge badge-danger float-right"><i class="fa fa-angle-double-left"></i> Kembali</a>
                    </h6>
                </div>
                    ...
                    <div class="overflow-auto" id="scrollTop" style="max-height: 400px;">
                        <ul class="chat-list list-unstyled">
                            ...
                            <?php foreach ($balas_konseling->result() as $a) : ?>
                                    ...
                                    <li class="clearfix chat-element right media">
                                        ...
                                        <div class="media-body">
                                            <div class="speech-box">
                                                <strong><b><?= $san['nama'] ?></b> <span class="float-right badge badge-success">siswa</span></strong>
                                                <p><?= $a->balasan ?></p>
                                ...
                                <?php elseif ($a->pengirim == 'Karyawan') : ?>
                                    <li style="margin-right:60px" class="clearfix chat-element left media">
                                        <a class="float-left">
                                            <img src="<?= base_url('assets/') ?>img/profile.png" width="50%" alt="" class="rounded-circle">
                                        </a>
                                        <div class="media-body">
                                            <div class="speech-box">
                                                <strong><b><?= $peng['nama'] ?></b> <span class="float-right badge badge-info">karyawan</span></strong>
                                                <p><?= $a->balasan ?></p>
                                                <small class="text-info"><?= $a->tgl ?>, <?= $a->waktu ?></small>
                                            </div>
                                        </div>
