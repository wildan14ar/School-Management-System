					...
					<tbody>
						...
						?>
								<tr>
									...
									<td>
										<a class="badge badge-danger" onclick="return confirm('Anda Akan Menghapus Pembayaran <?php echo $row['bebas_pay_desc'] ?>?')" title="Hapus" href="<?php echo site_url('payout/delete_pay_free/' . $row['period_id'] . '/' . $row['student_student_id'] . '/' . $row['bebas_bebas_id'] . '/' . $row['bebas_pay_id'] . '/' . $row['nis']) ?>""><span class="fa fa-trash"></span> Hapus</a>
									</td>
								</tr>
